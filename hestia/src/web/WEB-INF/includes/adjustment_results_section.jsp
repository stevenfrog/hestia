<%--
  ...
  -
  - Description: Table fragment for adjustment.
  - version 1.0
  - since Adjustments Freight and Branch Overrides
--%>

<!-- table section -->
<div class="table-section table-CW table-sw-type-adjustments">
    ...
    <div class="table-data">
        ...
        <div class="pagination">
            ...
            <div class="link-ul">
                <ul>
                    <li class="first"><a href="#" id="switchToFreight">Freight</a></li>
        ...
        <div class="input-prices">
            ...
            <div class="button">
                <a href="javascript:;" class="btn-undo" id="btn_undo_adjustment">UNDO</a>
                <a href="javascript:;" class="btn-save-all" id="btn_save_all_adjustment">SAVE ALL</a>
            </div>
...
<!-- table section -->
<div class="table-section table-other-type table-other-type-adjustments">
