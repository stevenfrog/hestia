<%--
  ...
  -
  - Description: Table fragment for branch overrides.
  - since Adjustments Freight and Branch Overrides
--%>

<!-- table section -->
<div class="table-section table-CW table-sw-type-branch-overrides">
    ...
    <div class="table-data">
        ...
        <div class="input-prices">
            ...
            <div class="button">
                <a href="javascript:;" class="btn-undo" id="btn_undo_branch_override">UNDO</a>
                <a href="javascript:;" class="btn-save-all" id="btn_save_all_branch_override">SAVE ALL</a>
            </div>
...
<!-- table section -->
<div class="table-section table-other-type table-other-type-branch-overrides">
