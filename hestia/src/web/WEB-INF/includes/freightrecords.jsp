<%--
  ...
  -
  - Description: Table fragment for cw records.
	...
	<table border="0" cellpadding="0" cellspacing="0" class="data" id="sw-input-prices-table">
		...
		<tbody>
	       <s:iterator value="pricingSheet">
		      <tr id='cw_freight_record_<s:property value="pricingRecordId"/>_<s:property value="branchId"/>' >
		           ...
		           <td><s:property value="newMultiplier"/></td>
		           <td><s:property value="newNetPrice"/></td>
		           ...
		           <td id="freight-cost"><s:property value="freightCost"/></td>
		           <td class="tip new-freight modify" abbr="New Freight">
		               <span class="adjustment-text"><s:property value="newFreightCost" /></span>
		               <input name="adjustmentValue" type="hidden" value='<s:property value="newFreightCost"/>'/>
		               <input name="adjustmentStartDate" type="hidden" value="<s:date name="newFreightCostStartDate" format="MM/dd/yyyy"/>"/>
		               <input name="adjustmentEndDate" type="hidden" value="<s:date name="newFreightCostEndDate" format="MM/dd/yyyy"/>"/>
		               <input name="adjustmentComment" type="hidden" value='<s:property value="newFreightCostComment"/>'/>
		               <input name="adjustmentCreatedBy" type="hidden" value='<s:property value="newFreightCostCreatedBy"/>'/>
		           </td>
